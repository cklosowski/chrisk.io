---
title: 'Why Your Next BIG Idea Should start small'
description: 'In the business of start-ups, entrepreneurship, and software development everyone seems to have a single goal. Find the one BIG idea that will become their…'
pubDate: 2014-05-26
heroImage: '/images/blog/lightbulbs-big-idea.jpg'
---
...
So how do you start a big idea, small? You iterate. Both of my major projects I'm working on started this way. A single idea that I (or a friend had). It wasn't a huge conversation. They both started with, what is probably, almost the same exact statement: _"There has to be a better way to do \_\_\_\_\_\_\_"_
...
Chris Lema posted a short while ago about about "[NOT Scratching Your Own Itch](http://chrislema.com/dont-scratch-your-itch/)", and his arguments are completely valid. I think though, that you can scratch an itch, while being completely aware of his concerns. You should read his post though, so you can be aware of the issues you may face. If there is one thing he has, it's experience.

##### What next?

After releasing your small project, there will be a time where feature requests and bugs alike roll in. This is where you start turning the small little niche idea, into a larger thing. One driven by user feedback. My most recent plugin, [Post Promoter Pro](https://chrisk.io/ppp), is being updated to version 1.3 soon, and it's consisting of 6 features, 5 suggested by users who purchased on day one.
...
**_What methods do you use to start projects? Do you believe in a completed idea or a minimum viable product (MVP)?_**
