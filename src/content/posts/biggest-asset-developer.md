---
title: 'Your biggest asset as a developer'
published: 2014-05-27
description: 'It''s tossed around on resumés, touted as why someone should be paid more, and used to taunt our prowess in the ever so changing world of software…'
image: '/images/blog/back-to-school1.jpg'
tags: ['code', 'coding', 'education', 'Evergreen', 'Software Development']
category: 'Software Development'
draft: false
---
It's tossed around on resumés, touted as why someone should be paid more, and used to taunt our prowess in the ever so changing world of software development. People with 18 years of JavaScript _(but it was Mocha back then)_ experience, people who remember writing COBOL, and those who hang on to assembly as their crowning jewel of achievement in their development toolbox. Don't get me wrong, all these languages and accolades hold their place in something each person should be proud of. If these people are _**still**_ software developers though, the one thing they should be touting is, **their ability to adapt**.
...
You might have read a previous post about how a project I was working on, was moving away from WordPress. I [outline my concerns and excitement to try something new](https://chrisk.io/2014/03/chance-learn-something-new/ "A Chance To Learn Something New"). I was waist deep in that project, and the one thing that I've realized is you have to Learn to Learn.
...
**_So what's your preferred learning method? Have you taken the time to learn something new lately? What was it?_**
